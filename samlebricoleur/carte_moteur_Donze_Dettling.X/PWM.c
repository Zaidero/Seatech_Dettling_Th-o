...
//void PWMSetSpeed(float vitesseEnPourcents, unsigned char motorNumber)//Gauche=1,Droite=0,
//{
//if (motorNumber == 1) {
...
void PWMSetSpeedConsigne(float vitesseEnPourcents, unsigned char motorNumber) {//Gauche=1,Droite=0,
    if (motorNumber == MOTEUR_GAUCHE)
